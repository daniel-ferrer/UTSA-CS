...
{ 
    ...
    double *ptrArr = (double*)malloc(ArraySize * sizeof(double));
...
{ 
    double *myarr = (double *)args; 
    double *myptrretSecondHalf = (double *)malloc(ArrayHalfSize * sizeof(double)); 
...
void *selectionSortFirstHalf(void *args) 
{
    ...
    double *myarr = (double *)args; 
    double *myptrretFirstHalf = (double *)malloc(ArrayHalfSize * sizeof(double)); 
...
{ 
    ...
    { 
        ...
        double *ThreadBlock, *ThreadArrayHalf1, *ThreadArrayHalf2; 
        double RandomNum, A[ArraySize], B[ArraySize], A_First_Half[ArrayHalfSize], A_Second_Half[ArrayHalfSize];
