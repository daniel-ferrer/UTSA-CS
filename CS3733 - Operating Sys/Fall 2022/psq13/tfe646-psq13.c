...
/* 
tfe646@fox01:~/UTSA-CS/CS3733 - Operating Sys/Fall 2022/psq13$ tfe646-psq13 1000 3.5 500 2.8
Balance = $2100.00 vs Total = $2100.00
tfe646@fox01:~/UTSA-CS/CS3733 - Operating Sys/Fall 2022/psq13$

tfe646@fox01:~/UTSA-CS/CS3733 - Operating Sys/Fall 2022/psq13$ tfe646-psq13 10000 10.8 5000 5.7
Balance = $79500.00 vs Total = $79500.00
tfe646@fox01:~/UTSA-CS/CS3733 - Operating Sys/Fall 2022/psq13$

The balance is equal to a*b-c*d because if we deposit $3.50
1000 times that leaves us with $3,500 and then if we withdraw 1,400 that
leaves us with a balance of $2,100. 
In terms of a, b, c, and d we could say (1000 * 3.50) - (500 * 2.80) = 2,100. 
*/
